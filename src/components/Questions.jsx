...
const Faq = () => {
  ...
  return (
    <section className='w-full px-4 py-8'>
      <div className='question-container grid gap-6 max-w-5xl mx-auto'>
        <h2 className='text-white mx-auto text-4xl font-bold'>FAQs</h2>
        <p className='text-white text-center mx-auto'> 
        Still have questions?<br></br>
        ...
        {questionsTabs.map((item, index) => (
          <div
            key={index}
            className='w-full bg-white p-6 rounded-2xl shadow-md hover:shadow-xl hover:bg-gray-50 transition-all duration-300 cursor-pointer'
